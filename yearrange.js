...
module.exports = {
    ...
    dateRules: [
        ...
        [/:centuryOffset(\d{2})th(?:\s*century\s*)?(?:\s*[-\/]\s*|\sto\s|\sor\s):centuryOffset(\d{2})th century/, function(match, date) {
        ...
        [/:centuryOffset(\d{2})th(?:\s*century\s*)?(?:\s*[-\/]\s*|\sto\s|\sor\s)(\d{2})th century/, function(match, date) {
            date.start = (parseFloat(match[2]) - 1) * 100;
            date.end = ((parseFloat(match[3]) - 1) * 100) + 99;
        ...
        [/(\d{2})th(?:\s*century\s*)?(?:\s*[-\/]\s*|\sto\s|\sor\s):centuryOffset(\d{2})th century/, function(match, date) {
